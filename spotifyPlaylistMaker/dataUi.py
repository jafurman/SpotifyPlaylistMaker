...
tracks_tree = ttk.Treeview(tracks_frame, columns=("Rank", "Track Name", "Artists"), show="headings", style="Treeview")
tracks_tree.heading("Rank", text="Rank")
tracks_tree.heading("Track Name", text="Track Name")
tracks_tree.heading("Artists", text="Artists")
tracks_tree.column("Rank", width=50)  # Adjusted width for Rank column
tracks_tree.pack(fill=tk.BOTH, expand=True, padx=10, pady=10)

# Create treeview for top artists
artists_tree = ttk.Treeview(artists_frame, columns=("Rank", "Artist Name", "Genres"), show="headings", style="Treeview")
...
artists_tree.column("Rank", width=50)
artists_tree.pack(fill=tk.BOTH, expand=True, padx=10, pady=10)
